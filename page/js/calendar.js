(function(root, factory) {
    ...
    var defaults = {
        ...
        ITEM_STYLE = 'style="width:{w}rem;height:{h}rem;line-height:{h}rem"',
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="上一月" data-calendar-arrow-date><i class="iconfont " style="font-size: 20px">{prev}</i></span>',
            '<span class="next" title="下一月" data-calendar-arrow-date><i class="iconfont " style="font-size: 20px">{next}</i></span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-arrow">',
            '<span class="prev" title="上一年" data-calendar-arrow-month><i class="iconfont " style="font-size: 20px">{prev}</i></span>',
            '<span class="next" title="下一年" data-calendar-arrow-month><i class="iconfont " style="font-size: 20px">{next}</i></span>',
            '</div>',
            '</div>',
    ...
    Calendar.prototype = {
        ...
        trigger: function() {
            ...
            $this.addClass('calendar-modal').css({
                left: (post.left + offs[0]) + 'rem',
                top: (post.top + _this.$trigger.outerHeight() + offs[1]) + 'rem',
        ...
        showLabel: function(event, view, date, data) {
            ...
            $lbl.css({
                left: (event.pageX - w / 2) + 'rem',
                top: (event.pageY - h - 20) + 'rem'
            }).show();
        },
        hasLabel: function() {
